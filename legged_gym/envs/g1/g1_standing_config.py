...
class G1StandingCfg(G1RoughCfg):
    ...
    class rewards(G1RoughCfg.rewards):
        ...
        class scales(G1RoughCfg.rewards.scales):
            ...
            # === STANDARD SAFETY ===
            torques = -1e-5
            dof_acc = -1e-7             # Very low to allow quick reaction
            dof_pos_limits = -10.0
            collision = -1.0
            action_rate = -0.05 
    ...
    class domain_rand(G1RoughCfg.domain_rand):
            ...
            added_mass_range = [-1.0, 6.0]  # Phase1: [-1.0, 3.0], Phase2: [-1.0, 5.0], Phase3: [-1.0, 6.0]
            push_robots = True
            push_interval_s = 3         # Phase1: 5, Phase2: 3
            max_push_vel_xy = 3.0       # Phase1: 1.5, Phase2: 2.5, Phase3: 3.0
